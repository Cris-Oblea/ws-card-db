...
| File | What it is |
|---|---|
| **`Complete_Abilities_List.xlsx`** | The **15,346** distinct abilities in the game, each with its measured cost (built by `build_official_list.py`). Sheets: *All abilities* (the table), *Summary*, *How to use*. |
...
| File | What it is |
|---|---|
| `cardlist_clean.json` | **JP source of truth**: 64,663 normalized cards (stats + abilities + markers). |
| `cardlist_en.json` | **Harvest from the official English site**: 18,727 cards with official EN text. |
